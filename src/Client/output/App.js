...
import { ProgramModule_mkProgram, ProgramModule_withConsoleTrace } from "./fable_modules/Fable.Elmish.4.0.1/program.fs.js";
import { update, initialState } from "./State.js";
...
import { Auto_generateBoxedEncoder_437914C6, uint64, int64, decimal } from "./fable_modules/Thoth.Json.10.0.0/Encode.fs.js";
import { Auto_generateBoxedDecoder_Z6670B51, uint64 as uint64_1, int64 as int64_1, decimal as decimal_1 } from "./fable_modules/Thoth.Json.10.0.0/Decode.fs.js";
import { empty } from "./fable_modules/Thoth.Json.10.0.0/Extra.fs.js";
import { ExtraCoders } from "./fable_modules/Thoth.Json.10.0.0/Types.fs.js";
import { State$reflection } from "./Types.js";
import { fromValue } from "./fable_modules/Thoth.Json.10.0.0/Decode.fs.js";
import { Debugger_ConnectionOptions } from "./fable_modules/Fable.Elmish.Debugger.4.0.0/debugger.fs.js";
import { getCaseFields, getCaseName as getCaseName_1, isUnion } from "./fable_modules/fable-library.4.0.0-theta-018/Reflection.js";
...
import { Cmd_map, Cmd_none } from "./fable_modules/Fable.Elmish.4.0.1/cmd.fs.js";
import { Msg$1 } from "./fable_modules/Fable.Elmish.HMR.7.0.0/hmr.fs.js";
import { Sub_map, Sub_batch } from "./fable_modules/Fable.Elmish.4.0.1/sub.fs.js";
import { ProgramModule_map, ProgramModule_runWith } from "./fable_modules/Fable.Elmish.4.0.1/program.fs.js";

(function () {
    let program_5;
    const program_4 = Program_Internal_withReactBatchedUsing((equal, view, state_1, dispatch_1) => lazyView2With(uncurry(2, equal), uncurry(2, view), state_1, dispatch_1), "elmish-app", ProgramModule_withConsoleTrace(ProgramModule_mkProgram(initialState, update, render)));
    try {
        let patternInput;
        try {
            let coders;
            ...
            const encoder_3 = Auto_generateBoxedEncoder_437914C6(State$reflection(), void 0, coders, void 0);
            const decoder_3 = Auto_generateBoxedDecoder_Z6670B51(State$reflection(), void 0, coders);
            patternInput = (() => {
                const deflate = (x) => {
                    try {
                        return encoder_3(x);
